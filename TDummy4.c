...
void Start_Task(){
	...
	delay(0.3); //Use 0.3 execution time for the fourth task
...
int main(){
	...
	set_param.sched_priority = 20; //Priority of the task is T1>T2/T4>T3 I set the the priority as 30, 20, 10, 20
